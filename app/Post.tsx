...
function UpvoteIcon() {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="h-6 w-6 -rotate-90 text-gray-500"
    >
      <path
        strokeLinecap="round"
...
function CommentIcon() {
  return (
    <svg
      ...
      strokeWidth={2}
      stroke="currentColor"
      className="h-6 w-6 p-[3px] text-gray-500"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
const pStyle = "flex items-center space-x-1 text-sm font-medium text-gray-400 dark:text-gray-200"
...
export async function Post({ id }: { id: number }) {
  ...
  return (
    <div className="h-18 mt-4 flex flex-row space-x-2 rounded-2xl bg-gray-100 p-4 text-gray-50 dark:bg-gray-900">
      {/* <div className="mt-0.5 flex flex-col items-center">
        <UpvoteIcon />
        <span className="text-xs">{post.score}</span>
      </div> */}
      <div className="flex flex-col space-y-1">
        <h2 className="text-base font-semibold text-zinc-100">{post.title}</h2>
